...
Command: npx gltfjsx@6.5.0 sofa123.glb 
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('./model/sofa123.glb')
  const sofaMaterial = new MeshStandardMaterial({ color: '#8B4513' }) // Brown
  const cushionMaterial = new MeshStandardMaterial({ color: '#FFFF00' }) // Yellow
  const legsMaterial = new MeshStandardMaterial({ color: '#C0C0C0', metalness: 0.8, roughness: 0.2 }) // Metallic steel
...
useGLTF.preload('./model/sofa123.glb')
